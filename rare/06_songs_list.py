...
# time_list = violator_songs_list[3][1] + violator_songs_list[5][1] + violator_songs_list[8][1]
# print(f"Три песни звучат {round(time_list, 3)} минут")
...
# time_dict = violator_songs_dict['Sweetest Perfection'] + violator_songs_dict['Policy of Truth'] + violator_songs_dict['Blue Dress']
...
def run():
    ...
    violator_songs_dict = {
        'World in My Eyes': 4.76, 'Sweetest Perfection': 4.43,
